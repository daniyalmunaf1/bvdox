...
<head>
  ...
  <!-- header-section end  -->
    ...
    <!-- inner hero start -->
    <section class="inner-hero bg_img" data-background="assets/images/contact1.jpg">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
    ...
    <section class="pt-120 pb-120 my-5">
      <div class="container">
        <div class="contact-wrapper">
          <div class="row">
            <div class="col-lg-6 contact-thumb bg_img" data-background="assets/images/contact2.jpg"></div>
            ...
            <div class="row mb-none-30">
              ...
              <div class="col-md-4 col-sm-6 mb-30 mx-auto">
                <div class="contact-item">
                  ...
                  <div class="mt-4">
                    <p><a href="mailto:demo@mail.com">bvdox@bvdox.com</a></p>
