          ...
          <nav class="navbar navbar-expand-xl p-0 align-items-center">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav main-menu m-auto">
                ...
                <li> <a href="plan.html">Invest</a></li>
                <li> <a href="withdrawal.html">Withdrawal</a></li>
                <li><a href="contact.html">Contact us</a></li>
                <li><a href="rewards.html">Rewards</a></li>
                <li class="pass-mobile"><a href="changePassword.html">Change Password</a></li>
                <li class="pass-mobile"><a href="#">Log Out</a></li>
                
              </ul>
              <div class="nav-right">
                <ul class="noti-ul account-menu row">
                  <li class="icon">
                    <a href="changePassword.html"><i>Change Password</i></a>
                  </li>
                <li class="icon">  <a href="#"><i>Log Out</i></a></li>
        ...
        <div class="row justify-content-center mb-none-30 my-5 container col-lg-6">
          <div class=" mb-30" style="width: 90%;">
            <div class="package-card text-center bg_img" data-background="assets/images/">
              ...
              <div class="package-card__range mt-2 text-small">Charges 4%</div>
              ...
              <a href="investUsdt.html"> <button class="cmn-btn mt-4">Invest Now</button></a>
...
color: black;
      ...
      <div class="row justify-content-center mb-none-30 my-5">
        <div class=" mb-30" style="width: 90%;">
          <div class="package-card text-center bg_img" data-background="assets/images/bg/bg-png">
            <h4 class="package-card__title base--color mb-2">Abdul Qasim <span class="text-small">
                <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                  class="fa fa-star"></i> <i class="fa fa-star"></i></span> </h4>

            <div class="package-card__range"> <span class="text-small">Price:</span> <span class="base--color"
                style="font-size: 30px;"> 240</span> <span class="text-small">PKR</span> </div>
            <div class="package-card__range mt-2 text-small">Available USDT 1000</div>
            <div class="package-card__range mt-2 text-small">Limit PKR 20000 - PKR 400000</div>
            <div class="package-card__range mt-2 text-small"> <span class="easypaisa mx-1"></span>Easypaisa <span
                class="bankTransfer mx-1"></span>Bank Transfer<span class="jazzCash mx-1"></span>jazzCash<span
                class="uPaisa mx-1"></span>U Paisa</div>

            <button class="cmn-btn mt-4" data-toggle="modal" data-target="#buyModal">Buy Now</button>
          </div><!-- package-card end -->
        </div>
      </div>
    </div>
    <div class="container col-lg-6">
      <div class="row justify-content-center mb-none-30 my-5">
        <div class=" mb-30" style="width: 90%;">
          <div class="package-card text-center bg_img" data-background="assets/images/bg/bg-png">
            <h4 class="package-card__title base--color mb-2">Qasim Rahman <span class="text-small">
    ...
    <div class="container col-lg-6">
      <div class="row justify-content-center mb-none-30 my-5">
        <div class=" mb-30" style="width: 90%;">
          <div class="package-card text-center bg_img" data-background="assets/images/bg/bg-png">
            <h4 class="package-card__title base--color mb-2">Usman <span class="text-small">
                <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                  class="fa fa-star"></i> <i class="fa fa-star"></i></span> </h4>
            ...
            <div class="package-card__range mt-5 ">Limit PKR 20000 - PKR 400000</div>
    ...
    <div class="container col-lg-6">
      <div class="row justify-content-center mb-none-30 my-5">
        <div class=" mb-30" style="width: 90%;">
          <div class="package-card text-center bg_img" data-background="assets/images/bg/bg-png">
            <h4 class="package-card__title base--color mb-2">Ali raza <span class="text-small">
    ...
    <div class="container col-lg-6">
      <div class="row justify-content-center mb-none-30 my-5">
        <div class=" mb-30" style="width: 90%;">
          <div class="package-card text-center bg_img" data-background="assets/images/bg/bg-png">
            <h4 class="package-card__title base--color mb-2">Hanzala <span class="text-small">
    ...
    <div class="container col-lg-6">
      <div class="row justify-content-center mb-none-30 my-5">
        <div class=" mb-30" style="width: 90%;">
          <div class="package-card text-center bg_img" data-background="assets/images/bg/bg-png">
            <h4 class="package-card__title base--color mb-2">Tahir <span class="text-small">
    ...
    <div class="container col-lg-6">
      <div class="row justify-content-center mb-none-30 my-5">
        <div class=" mb-30" style="width: 90%;">
          <div class="package-card text-center bg_img" data-background="assets/images/bg/bg-png">
            <h4 class="package-card__title base--color mb-2">Abdullah <span class="text-small">
    ...
    <div class="container col-lg-6">
      <div class="row justify-content-center mb-none-30 my-5">
        <div class=" mb-30" style="width: 90%;">
          <div class="package-card text-center bg_img" data-background="assets/images/bg/bg-png">
            <h4 class="package-card__title base--color mb-2">Ahsan <span class="text-small">
    ...
    <div class="container col-lg-6">
      <div class="row justify-content-center mb-none-30 my-5">
        <div class=" mb-30" style="width: 90%;">
          <div class="package-card text-center bg_img" data-background="assets/images/bg/bg-png">
            <h4 class="package-card__title base--color mb-2">Tariq <span class="text-small">
    ...
    <div class="container col-lg-6">
      <div class="row justify-content-center mb-none-30 my-5">
        <div class=" mb-30" style="width: 90%;">
          <div class="package-card text-center bg_img" data-background="assets/images/bg/bg-png">
            <h4 class="package-card__title base--color mb-2">Mohsin <span class="text-small">
          ...
          <div class="modal-body">
            ...
            <form>
              ...
              <div class="form-group">
                ...
                <input style="background: transparent;" type="number" class="form-control" id="exampleInputEmail1"
...
<a href="invest.html" class="cmn-btn">Submit</a>
